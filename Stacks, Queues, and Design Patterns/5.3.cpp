...
public:
    ...
    LinkedList& operator= (const LinkedList &obj1);
    bool isEmpty() const;
...
template <typename E>
LinkedList<E>::LinkedList(const LinkedList &obj)
{
    Node<E> *T;
    head = NULL;
    if(this != &obj)
...
template <typename E>
LinkedList<E>& LinkedList<E>::operator=(const LinkedList &obj1)
{
    Node<E> *T1;
    head = NULL;
    if(this != &obj1)
...
int main()
{
    ...
    cout << "1: " << *myList << endl;
    LinkedList<string> *myList2 = new LinkedList<string>(*myList);
    cout << "2: " << *myList2 << endl;
